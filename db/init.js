...
function initDatabase() {
    ...
    // Insert default copyright config if not exists
    ...
    if (!configExists) {
        db.prepare(`INSERT INTO copyright_config (author_name, copyright_text, website, email) VALUES (?, ?, ?, ?)`).run(
            'IDEL',
            '© 2026 IDEL. All rights reserved. 未经授权禁止转载和商业使用。',
            'https://idel.com',
            'work@idel.com'
        );
    ...
    // Insert default categories with existing data
    ...
    if (catCount.count === 0) {
        ...
        insertWork.run(cat1.lastInsertRowid, '失落协议 · 序章', 'AI短剧', 
            'https://images.unsplash.com/photo-1620641788421-7a1c342ea42e?auto=format&fit=crop&q=80',
            'https://images.unsplash.com/photo-1620641788421-7a1c342ea42e?auto=format&fit=crop&q=80', '',
            '在数字荒原中寻找人类最后的体温。当所有协议都被遗忘，唯有意图还在燃烧。', '', 1);
        insertWork.run(cat1.lastInsertRowid, '失落协议 · 崩塌', 'AI短剧',
            'https://images.unsplash.com/photo-1558618666-fcd25c85f82e?auto=format&fit=crop&q=80',
            'https://images.unsplash.com/photo-1558618666-fcd25c85f82e?auto=format&fit=crop&q=80', '',
            '系统崩溃前的最后一帧，数据碎片化为雪花。', '', 2);
        insertWork.run(cat1.lastInsertRowid, '失落协议 · 重生', 'AI短剧',
            'https://images.unsplash.com/photo-1635070041078-e363dbe005cb?auto=format&fit=crop&q=80',
            'https://images.unsplash.com/photo-1635070041078-e363dbe005cb?auto=format&fit=crop&q=80', '',
            '废墟之上，新的协议正在被书写。这一次，由人类执笔。', '', 3);
        ...
        insertWork.run(cat2.lastInsertRowid, '留白 #01', '摄影作品',
            'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&q=80',
            'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&q=80', '',
            '拍摄脚本：冷调、大面积留白。人与空间的对话。', '', 1);
        insertWork.run(cat2.lastInsertRowid, '留白 #02', '摄影作品',
            'https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?auto=format&fit=crop&q=80',
            'https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?auto=format&fit=crop&q=80', '',
            '拍摄脚本：侧面轮廓光。克制的情绪表达。', '', 2);
        insertWork.run(cat2.lastInsertRowid, '留白 #03', '摄影作品',
        ...
        insertWork.run(cat3.lastInsertRowid, '城市呼吸 · 上海', '摄像作品',
            'https://images.unsplash.com/photo-1492691527719-9d1e07e534b4?auto=format&fit=crop&q=80',
            'https://images.unsplash.com/photo-1492691527719-9d1e07e534b4?auto=format&fit=crop&q=80', '',
            '城市的节奏藏在天际线的轮廓里。日出时分，光影交织如同城市的呼吸。', '', 1);
        insertWork.run(cat3.lastInsertRowid, '海岸线 · 英吉', '摄像作品',
            'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?auto=format&fit=crop&q=80',
            'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?auto=format&fit=crop&q=80', '',
            '浪潮的节拍就是最好的配乐。每一帧都是大自然的即兴表演。', '', 2);
        insertWork.run(cat3.lastInsertRowid, '雨林 · 西双版纳', '摄像作品',
            'https://images.unsplash.com/photo-1536147116438-62679a5e01f2?auto=format&fit=crop&q=80',
            'https://images.unsplash.com/photo-1536147116438-62679a5e01f2?auto=format&fit=crop&q=80', '',
            '雨滴是森林的节拍器。每一棵树都在雨中跳着缓慢的华尔兹。', '', 3);
